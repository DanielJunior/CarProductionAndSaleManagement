 ...
 * @author danieljunior
 */
public class MostraFornecedor extends javax.swing.JFrame {

    /**
     * Creates new form MostraFornecedor
     * @param f
     */
    public MostraFornecedor(Fornecedor f) {
//        initComponents();
        exibir(f);
        setDefaultCloseOperation(DISPOSE_ON_CLOSE);
    }

    private MostraFornecedor() {
    ...
    private void exibir(Fornecedor f) {
        if (f != null) {
            ...
            jTextField2.setText(f.getEmail());
