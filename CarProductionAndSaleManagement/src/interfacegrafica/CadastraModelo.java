 ...
 * @author lorena
 */
public class CadastraModelo extends javax.swing.JFrame {

    /**
     * Creates new form CadastraModelo
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CadastraModelo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CadastraModelo().setVisible(true);
            }
        });
    }
