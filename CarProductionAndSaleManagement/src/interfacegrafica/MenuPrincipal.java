...
import comando.ComandoCadastrarPedido;
...
public class MenuPrincipal extends javax.swing.JFrame {
    ...
    public MenuPrincipal() {
        this.fachada = Sistema.getInstance();
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Sistema de Venda e Produção de Carros");
        setName("Aa"); // NOI18N
        ...
        jButton2.setText("Opções de Automóvel");
        ...
        jButton3.setText("Opções de Cliente");
        ...
        jButton4.setText("Opções de Estoque");
        ...
        jButton6.setText("Opções de Fornecedores");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        PluginLogin p = new PluginLogin(new ComandoCadastrarPedido());
        p.setVisible(true);
        dispose();
...
//        c.setVisible(true);
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        OpcoesFornecedor opcfornecedores = new OpcoesFornecedor();
        dispose();
